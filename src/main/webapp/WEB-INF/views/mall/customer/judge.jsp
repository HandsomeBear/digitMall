...
<html lang="en">
	...
	<body>
		...
		<div class="container" style="height:36px;background-color:#08bfc3;">
			<img alt="成功" src="<%=path%>/resources/images/success.jpg"/><span style="font-size:30px;vertical-align:middle;">交易成功</span>
		</div>
			...
			<div style="width:940px;height:200px;">
				...
				<div class="right">
					<div style="height:30px;">
						...
						<span id="score" style="vertical-align:middle;color:red"></span>
					</div>
		...
		<div class="container" style="min-height:186px;">
			<hr/>
			<div align=center>
