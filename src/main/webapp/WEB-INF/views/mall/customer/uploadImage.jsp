...
<html lang="en">
	<head>
		...
		<!--页面三要素-->
		<title>数码商城-修改图像</title>
		<meta name="Keywords" content="数码商城-修改图像">
		<meta name="description" content="数码商城-修改图像">
		...
		<div class="container">
			<div style="height:350px">
				...
				<div class="content" id="content">
					...
					<form action="person/uploadImage" method="post" enctype="multipart/form-data">
					<!-- 
						<input type="file" name="personImage"/>
					 -->
						<input id="lefile" type="file" style="display:none" name="personImage">
